...
import { mockResponseErrorNoAuth, mockResponseSuccessNoAuth } from './fixtures'
import { server as startServer } from '../../../src'
import { RequestMethod } from '../../../src/lib/constants'

export function authorizationNoAuthTests(): void {
  ...
  beforeAll(async () => {
    ...
    // process.env.GENERIC_AUTH_TYPE = 'no_auth' // NB: default
  ...
  describe('success calls', () => {
    ...
    responseDataCases.forEach((responseDataCase) => {
      it(`returns the expected result, when ${responseDataCase.name}`, async () => {
        ...
        mockResponseSuccessNoAuth(responseDataCase.testData.responseData)
