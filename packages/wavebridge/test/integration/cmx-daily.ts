...
export function cmxDailyTests(context: SuiteContext): void {
  ...
  describe('error calls', () => {
    ...
    describe('when unsuccessfully requests the CMX Index API', () => {
      it('should throw and exception', async () => {
        const data: AdapterRequest = {
          id,
          data: {
    ...
    describe('when successfully requests the CMX Index API', () => {
      const testCases = [
        {
          name: "response 'data' contains more than one item",
          mockApiResponse: mockCmxDailyResponseSuccessMalformed1,
        },
        {
          name: "'index' is not a number",
          mockApiResponse: mockCmxDailyResponseSuccessMalformed2,
        },
      ]
    ...
    const testCases = [
      {
        ...
        testData: {
          ...
          mockApiResponse: mockCmxDailyResponseSuccess1,
        },
      },
      {
        ...
        testData: {
          ...
          mockApiResponse: mockCmxDailyResponseSuccess2,
        },
      },
    ]
    it.each(testCases)('returns the CMX Index $name', async ({ testData }) => {
      mockAuthResponseSuccess()
