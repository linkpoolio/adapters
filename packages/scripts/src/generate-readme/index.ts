      ...
      const usage = commandLineUsage([
        {
          ...
          content:
            'This script is run from the root of the adapter/ repo to generate READMEs for supported adapters.',
        },
        {
          header: 'Options',
        ...
        {
          content:
            'Source code: {underline https://github.com/linkpoolio/adapters\n/packages/scripts/src/generate-readme/}',
        },
      ])
      console.log(usage)
      return
