...
![1.2.14](https://img.shields.io/github/package-json/v/linkpoolio/adapters?filename=packages/scripts/src/generate-readme/test/integration/readme-test-adapter/package.json)
