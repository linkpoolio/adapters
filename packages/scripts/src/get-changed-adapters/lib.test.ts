...
describe('get-changed-adapters cli', () => {
  ...
  describe('generateFilteredAdaptersListByType', () => {
    it('should return the different types of adapters when multiple exist are changed', () => {
      const changedFiles = ['packages/abc/src/package.json', 'packages/abc/test/package.json']
    ...
    it('should exclude non package and test files', () => {
      const changedFiles = ['packages/sources/abc/test/blarg.json', 'package.json']
      const changedAdapters = generateFilteredAdaptersListByType(changedFiles)
